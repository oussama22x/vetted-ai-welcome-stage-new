-- Add project status column with default activation state
...
-- Ensure new projects created through the helper function start in the pending activation state
...
BEGIN
  ...
  -- Insert project in pending activation state
...
-- Allow recruiters to update their project status in a controlled manner
