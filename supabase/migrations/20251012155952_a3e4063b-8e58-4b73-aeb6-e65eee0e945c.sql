...
-- Drop ALL existing resume storage policies to clean slate
...
DROP POLICY IF EXISTS "Admins can upload any resume" ON storage.objects;
DROP POLICY IF EXISTS "Admins can view any resume" ON storage.objects;
DROP POLICY IF EXISTS "Admins can update any resume" ON storage.objects;
DROP POLICY IF EXISTS "Admins can delete any resume" ON storage.objects;
